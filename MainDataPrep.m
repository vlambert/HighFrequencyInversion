...
% Read in data files
DataF=readseizmo('/Users/valerelambert/Seismo_Work/Back_Projection/Okhotsk2013/Processing/Zhe/Vel/*.BHZ');
...
pass = find(abs(corrcoeff) > 0.70 & SNR<0.1);
...
info.EVLA = EVLA;
info.EVLO = EVLO;
save(sprintf('StationData%.f.mat',nsta),'Data_pass','Time_pass','StaLat','StaLon','az','tt','rr','info','-v7.3');

save(sprintf('StationLags%.f.mat',nsta),'sta_lags','sta_pols','info','-v7.3');
