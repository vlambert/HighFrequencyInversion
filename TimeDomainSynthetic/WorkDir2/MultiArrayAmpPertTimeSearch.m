...
Misfit1=zeros(Ns,Ns,NOTi,NOTi);
Misfit2=zeros(Ns,Ns,NOTi,NOTi);
Misfitc=zeros(Ns,Ns,NOTi,NOTi);
...
for ti2 = 2:NOTi
    for ti3 = (ti2+1):NOTi
        OTi = [0.0 OTisearch(ti2) OTisearch(ti3)];
        for i2=1:Ns
            for i3=1:Ns
                ...
                Misfit1(i2,i3,ti2,ti3)=minmisfit1;
                Misfit2(i2,i3,ti2,ti3)=minmisfit2;
                Misfitc(i2,i3,ti2,ti3)=minmisfitc;
